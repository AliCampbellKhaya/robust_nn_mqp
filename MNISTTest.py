...
# print(np.max(results["iterations"]))
...
# print("original label:", results["final_label"][0])
# print("attacked label:", results["attack_label"][0])
# print("iterations:", results["iterations"][0])

# pert = results["perturbations"][0].squeeze()
# plt.subplot(1, 3, 1)
# plt.imshow(pert[0, :, :], cmap='gray')
# plt.title("Perturbation of image")
# plt.axis("off")

# image = results["pert_image"][0].squeeze().detach()
# plt.subplot(1, 3, 2)
# plt.imshow(image[0, :, :], cmap="gray")
# plt.title("attacked image")
# plt.axis("off")

# image = results["original_image"][0].squeeze().detach()
# plt.subplot(1, 3, 3)
# plt.imshow(image[0, :, :], cmap="gray")
