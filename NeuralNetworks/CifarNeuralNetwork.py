...
class CifarNeuralNetwork(BaseNeuralNetwork):
    def __init__(self, device, train_split, batch_size): 
        ...
        super(CifarNeuralNetwork, self).__init__("CIFAR", device, 3, 3200, 10, batch_size, train_dataloader, val_dataloader, test_dataloader, test_data)